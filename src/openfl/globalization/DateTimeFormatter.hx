					...
					for (token in tokens)
					{
						result += switch (token)
						{
							...
							case Era(length): // G
								...
								{
									case 5: (new DateTimeFormat(this._normalizedRequestedLocaleIDName,
											cast {era: "narrow", timeZone: timeZone})).formatToParts(date);
									case 4: (new DateTimeFormat(this._normalizedRequestedLocaleIDName,
											cast {era: "long", timeZone: timeZone})).formatToParts(date);
									default: (new DateTimeFormat(this._normalizedRequestedLocaleIDName,
											cast {era: "short", timeZone: timeZone})).formatToParts(date);
								});
							case Year(length): // y
								switch (length)
								{
							...
							case Month(length): // M
								...
								{
									case 1: (new DateTimeFormat(this._normalizedRequestedLocaleIDName,
											cast {month: "numeric", timeZone: timeZone})).formatToParts(date);
									case 2: (new DateTimeFormat(this._normalizedRequestedLocaleIDName,
											cast {month: "2-digit", timeZone: timeZone})).formatToParts(date);
									case 3: (new DateTimeFormat(this._normalizedRequestedLocaleIDName,
											cast {month: "short", timeZone: timeZone})).formatToParts(date);
									case 4: (new DateTimeFormat(this._normalizedRequestedLocaleIDName,
											cast {month: "long", timeZone: timeZone})).formatToParts(date);
									default: (new DateTimeFormat(this._normalizedRequestedLocaleIDName,
											cast {month: "narrow", timeZone: timeZone})).formatToParts(date);
								});
							case Date(length): // d
								getDateFormatPart("day", switch (length)
								{
									case 1: (new DateTimeFormat(this._normalizedRequestedLocaleIDName,
											cast {day: "numeric", timeZone: timeZone})).formatToParts(date);
									default: (new DateTimeFormat(this._normalizedRequestedLocaleIDName,
											cast {day: "2-digit", timeZone: timeZone})).formatToParts(date);
								});
							case Weekday(length): // E
								getDateFormatPart("weekday", switch (length)
								{
									case 5: (new DateTimeFormat(this._normalizedRequestedLocaleIDName,
											cast {weekday: "narrow", timeZone: timeZone})).formatToParts(date);
									case 4: (new DateTimeFormat(this._normalizedRequestedLocaleIDName,
											cast {weekday: "long", timeZone: timeZone})).formatToParts(date);
									default: (new DateTimeFormat(this._normalizedRequestedLocaleIDName,
											cast {weekday: "short", timeZone: timeZone})).formatToParts(date);
								});
							case Quarter(_): // Q
							...
							case Minute(length): // m
								...
								{
									case 1: (new DateTimeFormat(this._normalizedRequestedLocaleIDName,
											cast {minute: "numeric", timeZone: timeZone})).formatToParts(date);
									default: (new DateTimeFormat(this._normalizedRequestedLocaleIDName,
											cast {minute: "2-digit", timeZone: timeZone})).formatToParts(date);
								});
							case Second(length): // s
								getDateFormatPart("second", switch (length)
								{
									case 1: (new DateTimeFormat(this._normalizedRequestedLocaleIDName,
											cast {second: "numeric", timeZone: timeZone})).formatToParts(date);
									default: (new DateTimeFormat(this._normalizedRequestedLocaleIDName,
											cast {second: "2-digit", timeZone: timeZone})).formatToParts(date);
								});
							case Millisecond(length): // S
								""; // not supported by Intl.DateTimeFormat
							case TimeZoneDST(length): // z
			...
			private class DateTimeFormatTokenizer
			{
				public static function tokenize(format:String):Array<DateTimeFormatToken>
				{
					...
					while (i < format.length)
					{
						...
						if (currentToken != null
							&& newToken != null
							&& EnumValueTools.getName(newToken) == EnumValueTools.getName(currentToken))
						{
